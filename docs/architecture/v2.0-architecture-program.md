...
Status: active / Phase 3 Plugin SDK accepted; Phase 4 Research Workspace V2 is next; production plugin dispatch remains opt-in; public V2 creation remains deterministic-only
