...
|---|---|---|---|
| `app/services/evaluation/service.py` | `EvaluationApplicationPort` is now public; metrics and Artifact observation are split; benchmark/runtime coordination remains next | `EvaluationService` façade | V1.11/V1.12 evaluation tests |
| `app/services/evidence_registry.py` | separate domain contract from storage mapping | existing module exports | V1.4/V1.5 evidence tests |
