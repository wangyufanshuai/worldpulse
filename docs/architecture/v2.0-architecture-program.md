...
| `app/services/run_lifecycle/repository.py` | API/Worker use the application port; Artifact SQL, integrity hashing and persistence mappers are now isolated behind compatibility exports; projection/audit read models remain next | repository import surface | lifecycle, recovery and PostgreSQL tests |
