...
| `app/services/project_app/service.py` | v1/v5 routes use the application port; read views use a typed Read Service and Replay Pack assembly now has a dedicated application adapter; report adapter remains next | `app.services.projects` | project and replay tests |
