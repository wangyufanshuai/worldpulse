...
| `app/services/project_app/service.py` | v1/v5 project routes now use a Research Workspace application port; `app.services.projects` remains the compatibility façade while report/workspace/replay adapters migrate next | `app.services.projects` | project and replay tests |
