...
|---|---|---|---|
| `app/services/evaluation/service.py` | expose application ports; split benchmark/runtime coordination | `EvaluationService` façade | V1.11/V1.12 evaluation tests |
