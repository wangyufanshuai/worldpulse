...
| `app/services/evidence_registry.py` | `EvidenceApplicationPort` and compatibility adapter now isolate API, Compiler, Ingestion, Trust and Replay callers; storage mapping remains next | existing module exports | V1.4/V1.5 evidence tests |
