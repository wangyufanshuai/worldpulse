...
Phase 2 Kernel V2 remains a separate checkpoint and has not started. Its entry
requires an ADR for deterministic clock/state-delta/checkpoint contracts and a
Golden Scenario hash gate before any runtime formula or persistence change.
