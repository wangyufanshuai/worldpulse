...
Status: active / Phase 1 modular-monolith migration
...
World Model is now the current slice, after Identity & Organization, Evidence & Ingestion, Scenario Compiler, Run Control Plane and
