...
| `app/services/project_app/service.py` | v1/v5 project routes use the application port; side-effect-free project/run/workspace reads now use a typed Read Service, while report/replay command adapters migrate next | `app.services.projects` | project and replay tests |
