...
Status: active / Phase 3 Plugin SDK Slice 3D accepted; production plugin dispatch remains opt-in; public V2 creation remains deterministic-only
...
SDK is not an empty abstraction, but Phase 3 is not complete until Slice 3E
adds the report renderer and binds plugin manifests/configuration hashes into
formal Report and Replay Pack lineage.
