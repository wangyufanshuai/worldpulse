...
Status: active / Phase 3 Plugin SDK Slice 3C accepted; production plugin dispatch remains opt-in; public V2 creation remains deterministic-only
...
The next authorized Slice 3D adds one real active Rule Pack adapter and one
real Evaluator adapter without changing activation, calibration, human review,
historical label or blind-label governance.
