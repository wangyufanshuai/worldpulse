...
def validate_source_plan(payload: dict[str, Any], profile: str = "release") -> dict[str, Any]:
    ...
    # Preserve hashes for source plans produced before the governed Pilot
    # workflow. A finalized Pilot opts into the stronger dossier/reviewer
    # binding by carrying either of these fields.
    if normalized["curation_dossier_hash"] or normalized["reviewer"]:
        hash_body.update({
