...
V17_TABLES = {
    "worker_nodes", "organization_quotas", "organization_quota_events",
}
V18_TABLES = {
    "agent_packs", "negotiation_sessions", "negotiation_rounds", "negotiation_messages",
    "negotiation_commitments", "negotiation_commitment_events",
}
V19_TABLES = {
    "source_documents", "document_extraction_jobs", "document_extraction_event_counters",
    "document_extraction_events", "document_extractions", "scenario_candidates",
    "scenario_candidate_decisions", "scenario_drafts", "scenario_draft_items", "scenario_draft_reviews",
}
V110_TABLES = {
    "monitoring_sources", "monitoring_poll_jobs", "monitoring_poll_event_counters",
    "monitoring_poll_events", "monitoring_entries", "monitoring_watchlists",
    "monitoring_watch_rules", "intelligence_alerts", "intelligence_alert_events",
    "alert_subscriptions", "organization_notification_counters", "in_app_notifications",
    "webhook_deliveries",
}
V111_TABLES = {
    "evaluation_suites", "evaluation_cases", "evaluation_batches", "evaluation_members",
    "evaluation_metrics", "evaluation_event_counters", "evaluation_events",
}
V112_TABLES = {
    "historical_benchmark_suites", "historical_benchmark_cases", "historical_benchmark_evidence",
    "historical_label_packs", "historical_label_pack_reviews", "evaluation_gate_manifests",
...
def verify_schema(db_path: str | Path) -> dict:
    ...
    with _connect(target) as conn:
        tables = _tables(conn)
        missing = (BASELINE_TABLES | V13_TABLES | V14_TABLES | V15_TABLES | V17_TABLES | V18_TABLES | V19_TABLES | V110_TABLES | V111_TABLES | V112_TABLES | {"schema_migrations"}) - tables
        if missing:
